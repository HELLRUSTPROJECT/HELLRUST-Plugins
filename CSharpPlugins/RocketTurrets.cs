...
{
    [Info("RocketTurrets", "k1lly0u", "2.0.26")]
        ...
        private class StandardRocket : MonoBehaviour
        {
            ...
            protected virtual void OnDestroy()
            {
                ...
                if (explosive.creatorEntity != null && damageTypes != null)
                {
                    ...
                    Rust.Ai.Sensation sensation = new Rust.Ai.Sensation()
                    {
                        Type = Rust.Ai.SensationType.Explosion,
                        Position = explosive.creatorEntity.transform.position,
                        Radius = explosive.explosionRadius * 17f,
                        DamagePotential = damageAmount,
                        InitiatorPlayer = explosive.creatorEntity as BasePlayer,
                        Initiator = explosive.creatorEntity
                    };
                    Rust.Ai.Sense.Stimulate(sensation);
                }
